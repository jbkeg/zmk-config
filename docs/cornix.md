...
| Dongle (single keyboard) | `nice_nano//zmk` | `cornix_dongle zdd_adapter dongle_display` | `studio-rpc-usb-uart` | `cornix_zdd_dongle` | Active |
| Dongle reset | `nice_nano//zmk` | `settings_reset` | none | `cornix_zdd_dongle_reset` | Active |
